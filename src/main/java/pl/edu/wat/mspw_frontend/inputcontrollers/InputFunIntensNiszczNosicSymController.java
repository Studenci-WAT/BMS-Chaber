...
import pl.edu.wat.mspw_frontend.readcontrollers.TableFunIntensNiszczNosicSymController;
...
public class InputFunIntensNiszczNosicSymController {
    private FunIntensNiszczNosicSymService funIntensNiszczNosicSymService = new FunIntensNiszczNosicSymService();
    private TableFunIntensNiszczNosicSymController tableController;
    ...
    public void initialize() {
        ...
        loadTableView(TableViews.TABLE_FUN_INTENS_NISZCZ_NOSIC_SYM.getValue());
    ...
    private void setupDynamicControls() {
        ...
        InputControllerStatic.generateDynamicControl("INTENSYWNOSC", "INTENSYWNOSC", dynamicControls, 1, TextField.class, null, controller, inputGridPane);
        InputControllerStatic.generateDynamicControl("ODLEG", "ODLEG", dynamicControls, 2, TextField.class, null, controller, inputGridPane);
        InputControllerStatic.generateDynamicControl("CEL_OPANC", "CEL_OPANC", dynamicControls, 3, TextField.class, null, controller, inputGridPane);
        InputControllerStatic.generateDynamicControl("POZIOM_WYSZK", "POZIOM_WYSZK", dynamicControls, 4, TextField.class, null, controller, inputGridPane);
        InputControllerStatic.generateDynamicControl("POZIOM_ZDOLN_MANEWR", "POZIOM_ZDOLN_MANEWR PRZYRZ OC", dynamicControls, 5, TextField.class, null, controller, inputGridPane);
        InputControllerStatic.generateDynamicControl("KLASA_STRZEL", "KLASA_STRZEL", dynamicControls, 6, TextField.class, null, controller, inputGridPane);
        InputControllerStatic.generateDynamicControl("KLASA_CELU", "KLASA_CELU", dynamicControls, 7, TextField.class, null, controller, inputGridPane);
        InputControllerStatic.generateDynamicControl("WSP_A", "WSP_A", dynamicControls, 8, TextField.class, null, controller, inputGridPane);
        InputControllerStatic.generateDynamicControl("WSP_B", "WSP_B", dynamicControls, 9, TextField.class, null, controller, inputGridPane);
        InputControllerStatic.generateDynamicControl("ZASIEG_MIN", "ZASIEG_MIN", dynamicControls, 10, TextField.class, null, controller, inputGridPane);
        InputControllerStatic.generateDynamicControl("ZASIEG_MAX", "ZASIEG_MAX", dynamicControls, 11, TextField.class, null, controller, inputGridPane);
    }
    ...
    private void addButtonAction() {
        ...
        try {
            if (!InputControllerStatic.isAnyControlEmpty(dynamicControls)) {
                funIntensNiszczNosicSymService.create(
                        FunIntensNiszczNosicSymDto.builder()
    ...
    private void deleteButtonAction() {
        FunIntensNiszczNosicSymDto selectedFireSys = tableController.getTableView().getSelectionModel().getSelectedItem();
        Stage stage = (Stage) deleteButton.getScene().getWindow();
        if (selectedFireSys != null) {
            try {
                funIntensNiszczNosicSymService.delete(Long.valueOf(selectedFireSys.getId()));
