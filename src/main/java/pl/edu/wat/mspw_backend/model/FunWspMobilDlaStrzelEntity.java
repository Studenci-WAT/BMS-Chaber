...
@NoArgsConstructor
@Entity
@Table(name = "fun_wsp_mobil_dla_strzel", schema = "mspwTest", catalog = "")
public class FunWspMobilDlaStrzelEntity {
    ...
    public boolean equals(Object o) {
        ...
        FunWspMobilDlaStrzelEntity that = (FunWspMobilDlaStrzelEntity) o;
