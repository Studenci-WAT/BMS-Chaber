...
@NoArgsConstructor
@Entity
@Table(name = "fun_wsp_widocz_dla_wykr", schema = "mspwTest", catalog = "")
public class FunWspWidoczDlaWykrEntity {
    ...
    public boolean equals(Object o) {
        ...
        FunWspWidoczDlaWykrEntity that = (FunWspWidoczDlaWykrEntity) o;
