...
@NoArgsConstructor
@Entity
@Table(name = "fun_intens_niszcz_nosic_sym_2", schema = "mspwTest", catalog = "")
public class FunIntensNiszczNosicSym2Entity {
    ...
    public boolean equals(Object o) {
        ...
        FunIntensNiszczNosicSym2Entity that = (FunIntensNiszczNosicSym2Entity) o;
