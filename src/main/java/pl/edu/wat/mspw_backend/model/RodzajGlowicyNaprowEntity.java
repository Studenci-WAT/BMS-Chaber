...
@NoArgsConstructor
@Entity
@Table(name = "e_rodzaj_glowicy_naprow", schema = "mspwTest", catalog = "")
public class RodzajGlowicyNaprowEntity {
    ...
    public boolean equals(Object o) {
        ...
        RodzajGlowicyNaprowEntity that = (RodzajGlowicyNaprowEntity) o;
