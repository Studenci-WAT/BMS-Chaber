...
@NoArgsConstructor
@Entity
@Table(name = "e_kategoria_celu_razenia", schema = "mspwTest", catalog = "")
public class KategoriaCeluRazeniaEntity {
    ...
    public boolean equals(Object o) {
        ...
        KategoriaCeluRazeniaEntity that = (KategoriaCeluRazeniaEntity) o;
